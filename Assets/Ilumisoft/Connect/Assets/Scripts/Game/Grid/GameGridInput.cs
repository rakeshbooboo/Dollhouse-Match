namespace Ilumisoft.Connect.Game
{
    ...
    public class GameGridInput
    {
        ...
        /// <returns></returns>
        public bool InputRaycast(out GameGridElement element)
        {
            element = null;
        ...
        /// </summary>
        /// <param name="element"></param>
        public void ProcessGridElement(GameGridElement element)
        {
        ...
        /// <param name="element"></param>
        /// <returns></returns>
        public bool IsSecondLast(GameGridElement element)
        {
        ...
        /// <param name="element"></param>
        /// <returns></returns>
        public bool IsSelectable(GameGridElement element)
        {
        ...
        /// <param name="element"></param>
        /// <returns></returns>
        public bool HasValidColor(GameGridElement element)
        {
            //return element.Color == this.selectionLine.Color;
            return element.sprite == this.sprite;
        }
        ...
        /// <param name="element"></param>
        /// <returns></returns>
        public bool IsInDistance(GameGridElement element)
        {
        ...
        /// <param name="element"></param>
        public void AddElementToSelection(GameGridElement element)
        {
            if (this.SelectedElements.Count > 0)
            {
